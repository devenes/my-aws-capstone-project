# Blog Page Application (Django) deployed on AWS Application Load Balancer with Auto Scaling, S3, Relational Database Service(RDS), VPC's Components, DynamoDB and Cloudfront with Route 53 (SOLUTION)
...
## Step 5: Copy files downloaded or cloned from `enes_project` repo on Github

## Step 6: Prepair your Github repository

- Create private project repository on your Github and clone it on your local. Copy all files and folders which are downloaded from enes repo under this folder. Commit and push them on your private Git hup Repo.
...
## Step 8: Write RDS database endpoint and S3 Bucket name in settings file given by enes Fullstack Developer team and push your application into your own public repo on Github
...
Create new Notification
    - Notification1
        ...
        - with these recipients     : enes@enes.com
...
Alternate Domain Names                  : www.enes.us
